<template>
  <v-data-table :headers="headers" :items="mousses" :sort-by="[{ key: 'tipo', order: 'asc' }]">
    <template v-slot:top>
      <v-toolbar flat>
              ...
              <v-container>
                <v-row>
                  <v-col cols="12" md="6" sm="8">
                    <v-text-field v-model="editedItem.name" label="Nome da receita"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6" sm="8">
                    <v-text-field v-model="editedItem.tipo" label="tipo"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6" sm="8">
                    <v-text-field v-model="editedItem.origem" label="origem"></v-text-field>
                  </v-col>

                  <v-col cols="12" md="6" sm="8">
                    <v-text-field v-model="editedItem.ingrediente" label="ingrediente principal"></v-text-field>
                  </v-col>
                </v-row>
              </v-container>
            </v-card-text>
    ...
    <template v-slot:item.actions="{ item }">
      <v-btn color="primary" size="small" class="mr-4">Ver Receita</v-btn>
...
import { useReceitaStore } from '@/store/receitasStore'
